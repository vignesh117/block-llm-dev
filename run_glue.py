...
def main():
    ...
    if args.enable_blockllm:
        ...
        """
        1. Changing the default optimizer to AdamBCDConservative
        2. Finding a way to call `adjust_parameters_selective_weighted_greedy` after every
            x iterations. Where x is a hyperparameter, that is defined in the argparse
            2.1 Define the update frequency parameter in the argparse parser
    ...
    logger.info(f" Update frequency =  {update_freq}")
